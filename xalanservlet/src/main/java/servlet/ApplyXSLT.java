...
public class ApplyXSLT extends HttpServlet
{
 ...
 /**
   ...
   * operational parameters.  <p>If successfully applied, the result
   * tree will be streamed to the response object and the content type
   * set according to the XSL stylesheet's &lt;xsl:output>
   * element(s).</p> <p>If there is a problem in parsing the XML/XSL
   ...
   * whether we're running in debug mode or not.</p>
