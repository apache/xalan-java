...
/**
 * Implementation of XML Schema data type xs:nonPositiveInteger.
 * 
 * @author : Mukul Gandhi <mukulg@apache.org>
 */
public class XSNonPositiveInteger extends XSInteger {
	
	private static final long serialVersionUID = -6635639866433829301L;
	 ...
	 * Class constructor.
	 */
	public XSNonPositiveInteger(BigInteger val) throws TransformerException {
	   super(val);
	   int cmprResult = val.compareTo(BigInteger.valueOf(0));
	   if (cmprResult == 1) {
		  throw new TransformerException("FOCA0003 : An xs:nonPositiveInteger value cannot be greater than 0.");  
	   }			   	
	}
	 ...
	 * Class constructor.
	 */
	public XSNonPositiveInteger(String val) throws TransformerException {
	   super(val);
	...
	public int getType() {
	   return CLASS_NON_POSITIVE_INTEGER;
	}
