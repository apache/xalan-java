<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">     
    <result>
       <one>
          <xsl:value-of select="fn0:addMonthsToDateTime(xs:dateTime('2007-10-05T10:00:00'), 10)"/>
       </one>
       <two>
          <xsl:value-of select="fn0:addYearsToDateTime(xs:dateTime('2007-10-05T10:00:00'), 5)"/>
       </two>
       <three>
          <xsl:value-of select="fn0:addYearsAndMonthsToDateTime(xs:dateTime('2007-10-05T10:00:00'), 2, 10)"/>
       </three>
    </result>
  </xsl:template>
