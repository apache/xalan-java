...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- An XSLT stylesheet test, to test an XPath 3.1 fn:parse-json function call 
         that get's json string as an argument. This json string is formed using 
         information from an external json text file (which is read via XPath 3.1 
    ...
    <xsl:template match="/">
       <xsl:variable name="jsonStr" select="unparsed-text('file1.json')"/>
