...
public class FuncStartsWith extends XSL3StringCollationAwareFunction
{
  ...
  public XObject execute(XPathContext xctxt) throws javax.xml.transform.TransformerException
  {
	   ...
	   * application. In this case, fn:starts-with function returns its result
	  ...
	  if ((arg0StrValue != null) && (arg1StrValue != null)) {	    	
		  if (numOfArgs == 2) {
			  ...
			  String xpathInlineFuncExprStr = "function($collation) { starts-with('" + arg0StrValue + "', '" + arg1StrValue + "', $collation) }";
		  ...
		  if (numOfArgs == 2) {
			  String xpathInlineFuncExprStr = "function($arg0) { starts-with($arg0, '" + arg1StrValue + "') }";
			  ...
			  String xpathInlineFuncExprStr = "function($arg0) { starts-with($arg0, '" + arg1StrValue + "', '" + collationUri + "') }";
			  ...
			  String xpathInlineFuncExprStr = "function($arg0, $collation) { starts-with($arg0, '" + arg1StrValue + "', $collation) }";
		  ...
		  if (numOfArgs == 2) {
			  String xpathInlineFuncExprStr = "function($arg1) { starts-with('" + arg0StrValue + "', $arg1) }";
			  ...
			  String xpathInlineFuncExprStr = "function($arg1) { starts-with('" + arg0StrValue + "', $arg1, '" + collationUri + "') }";
			  ...
			  String xpathInlineFuncExprStr = "function($arg1, $collation) { starts-with('" + arg0StrValue + "', $arg1, $collation) }";
		  ...
		  if (numOfArgs == 2) {
			  String xpathInlineFuncExprStr = "function($arg0, $arg1) { starts-with($arg0, $arg1) }";
			  ...
			  String xpathInlineFuncExprStr = "function($arg0, $arg1) { starts-with($arg0, $arg1, '" + collationUri + "') }";
			  ...
			  String xpathInlineFuncExprStr = "function($arg0, $arg1, $collation) { starts-with($arg0, $arg1, $collation) }";
