    ...
    public XObject execute(XPathContext xctxt) throws javax.xml.transform.TransformerException
    {
       ...
       if (arg0 instanceof NodeTest) {
    	   if (XslTransformEvaluationHelper.isNodeTestExpressionFuntionType((NodeTest)arg0)) {
    		   throw new javax.xml.transform.TransformerException("FOTY0013 : An xdm atomic value is required for the first argument of XPath function atan(), "
    				                                                                   + "but the supplied type is a function type, which cannot be atomized.", srcLocator); 
    	   }
       }
       else if (arg0 instanceof XPathInlineFunction) {
      	  throw new javax.xml.transform.TransformerException("FOTY0013 : An xdm atomic value is required for the first argument of XPath function atan(), but the "
       ...
       if (arg0Result instanceof XNumber) {
          ...
          if (xNodeSet.getLength() != 1) {
        	 throw new javax.xml.transform.TransformerException("XPTY0004 : The argument to XPath function call atan() must be a sequence of length one.", srcLocator);   
          }
          else {
             ...
             try {
            	...
            	throw new javax.xml.transform.TransformerException("FORG0001 : Error occured during XPath function call atan(). Cannot convert "
    	   ...
    	   throw new javax.xml.transform.TransformerException("XPTY0004 : An xdm item type of first argument to XPath function call atan() is not "
