 ...
 * @xsl.usage advanced
 */
public class VcLe extends XPathRelationalOp
{
  ...
  {      	  
	  ...
	  if (left instanceof ElemFunctionItem) {
		 throw new javax.xml.transform.TransformerException("FOTY0013 : An XPath 3.1 operator le's first operand is a function type, "
		 		                                                                                                          + "which cannot be atomized.", srcLocator);   
	  }
	  
	  if (right instanceof ElemFunctionItem) {
		 throw new javax.xml.transform.TransformerException("FOTY0013 : An XPath 3.1 operator le's second operand is a function type, "
		 		                                                                                                          + "which cannot be atomized.", srcLocator);   
	  }
		  ...
		  if (nodeHandle != DTM.NULL) {
			  ...
			  if (node instanceof ElementPSVI) {
				  ...
				  if (typeDefn instanceof XSComplexTypeDefinition) {
					  throw new javax.xml.transform.TransformerException("FOTY0013 : An XPath 3.1 operator 'le' operand, cannot be a "
	  ...
	  // Validating an XPath 3.1 operator 'le' operands compatibility for value comparison	  
	  ...
	  if (isLEmpty || isREmpty) {
		 // An XPath 3.1 operator 'le' has one or both of it's operands as empty sequence
