...
public class VcGe extends Operation
{
                                                 ...
                                                 throws javax.xml.transform.TransformerException
  {
      ...
      if (left instanceof ElemFunctionItem) {
		  throw new javax.xml.transform.TransformerException("FOTY0013 : An XPath operator ge's lhs argument is a function type, which cannot be atomized.");   
	  }

	  if (right instanceof ElemFunctionItem) {
		  throw new javax.xml.transform.TransformerException("FOTY0013 : An XPath operator ge's rhs argument is a function type, which cannot be atomized.");   
	  }
