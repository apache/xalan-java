...
public class VcNotEquals extends XPathRelationalOp
{
                                                  ...
                                                  javax.xml.transform.TransformerException
  {
	  ...
	  if (left instanceof ElemFunctionItem) {
		 throw new javax.xml.transform.TransformerException("FOTY0013 : An XPath operator ne's first operand is a function type, "
		 		                                                                                                          + "which cannot be atomized.", srcLocator);   
	  }
	  
	  if (right instanceof ElemFunctionItem) {
		 throw new javax.xml.transform.TransformerException("FOTY0013 : An XPath operator ne's second operand is a function type, "
		 		                                                                                                          + "which cannot be atomized.", srcLocator);   
	  }
