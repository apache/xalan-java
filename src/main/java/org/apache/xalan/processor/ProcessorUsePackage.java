...
/**
 * TransformerFactory for xsl:use-package markup.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage internal
 */
class ProcessorUsePackage extends ProcessorTemplateElem
{
  ...
  protected void appendAndPush(StylesheetHandler handler, 
	  ...
	  handler.getStylesheet().setUsePackage((ElemUsePackage)elem);
  }
