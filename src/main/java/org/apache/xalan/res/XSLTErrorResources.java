...
// the attribute value and {0} is the attribute name.
    { INVALID_BOOLEAN,
     "XTSE0020 : [line {2}, column {3}] Illegal value: {1} used for boolean attribute: {0} "},
...
// ER_DUPLICATE_VAR - new error message for bugzilla #790
  ...
  { "optionINIT_TEMPLATE", "   [-INIT_TEMPLATE (Specify an XSL template's name to select an initial template for stylesheet transformation)]"},
  ...
  { "optionINIT_FUNCTION", "   [-INIT_FUNCTION (Specify an XSL function's name to select an initial function for stylesheet transformation)]"},
