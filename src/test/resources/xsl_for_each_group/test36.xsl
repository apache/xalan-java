  ...
  <xsl:template match="/">
     ...
     <xsl:variable name="groupedMapXmlNode">		
		<map xmlns="http://www.w3.org/2005/xpath-functions">
		  <!-- Forming groups by first letter of 'fName' -->
	      <xsl:for-each-group select="$personsXmlNode/fn:map/fn:array/fn:map" group-by="upper-case(substring(fn:string[@key = 'fName'], 1, 1))">
