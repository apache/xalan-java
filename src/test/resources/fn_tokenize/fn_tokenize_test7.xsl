...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- An XSL 3 fn:tokenize function test case. This stylesheet reuses the 
       ...
       XSL transform's output via an XSL named template. -->
  ...
  <!-- An XSL stylesheet named template, to emit contents of a sequence of token 
       strings to an XSL transform's output. -->
