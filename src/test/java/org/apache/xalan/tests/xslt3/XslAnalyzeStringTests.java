...
public class XslAnalyzeStringTests extends XslTransformTestsUtil {     
    ...
    private static final String XSL_TRANSFORM_INPUT_DIRPATH = XSLTestConstants.XSL_TRANSFORM_INPUT_DIRPATH_PREFIX + "xsl_analyze_string/";
    
    private static final String XSL_TRANSFORM_GOLD_DIRPATH = XSLTestConstants.XSL_TRANSFORM_GOLD_DIRPATH_PREFIX + "xsl_analyze_string/gold/";
    ...
    @Test
    public void xslAnalyzeStringTest14() {
    ...
    @Test
    public void xslAnalyzeStringTest15() {
    ...
    @Test
    public void xslAnalyzeStringTest16() {
        String xmlFilePath = XSL_TRANSFORM_INPUT_DIRPATH + "test2.xml"; 
