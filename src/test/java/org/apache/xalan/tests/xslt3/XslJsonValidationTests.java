...
/**
 * XSL stylesheet test cases, to validate JSON documents using 
 * XPath 3.1 JSON document parse functions and sequence type 
 * expressions.
 * 
 ...
 * @xsl.usage advanced
 */
public class XslJsonValidationTests extends XslTransformTestsUtil {
    
    private static final String XSL_TRANSFORM_INPUT_DIRPATH = XSLTestConstants.XSL_TRANSFORM_INPUT_DIRPATH_PREFIX + "xsl_json_validation/";
    
    private static final String XSL_TRANSFORM_GOLD_DIRPATH = XSLTestConstants.XSL_TRANSFORM_GOLD_DIRPATH_PREFIX + "xsl_json_validation/gold/";      
    ...
    @Test
    public void xslJsonValidationTest1() {
    ...
    @Test
    public void xslJsonValidationTest2() {
    ...
    @Test
    public void xslJsonValidationTest3() {
    ...
    @Test
    public void xslJsonValidationTest4() {
    ...
    @Test
    public void xslJsonValidationTest5() {
    ...
    @Test
    public void xslJsonValidationTest6() {
    ...
    @Test
    public void xslJsonValidationTest7() {
    ...
    @Test
    public void xslJsonValidationTest8() {
    ...
    @Test
    public void xslJsonValidationTest9() {
    ...
    @Test
    public void xslJsonValidationTest10() {
    ...
    @Test
    public void xslJsonValidationTest11() {
