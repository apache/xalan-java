...
/**
 * XSL stylesheet test cases, to test xsl:character-map 
 * instruction.
 * 
 ...
 * @xsl.usage advanced
 */
public class XslCharacterMapTests extends XslTransformTestsUtil {
    
    private static final String XSL_TRANSFORM_INPUT_DIRPATH = XSLTestConstants.XSL_TRANSFORM_INPUT_DIRPATH_PREFIX + "xsl_character_map/";
    
    private static final String XSL_TRANSFORM_GOLD_DIRPATH = XSLTestConstants.XSL_TRANSFORM_GOLD_DIRPATH_PREFIX + "xsl_character_map/gold/";      
    ...
    @Test
    public void xslCharacterMapTest1() {
    ...
    @Test
    public void xslCharacterMapTest2() {
    ...
    @Test
    public void xslCharacterMapTest3() {
    ...
    @Test
    public void xslCharacterMapTest4() {
    ...
    @Test
    public void xslCharacterMapTest5() {
    ...
    @Test
    public void xslCharacterMapTest6() {
    ...
    @Test
    public void xslCharacterMapTest7() {
        String xmlFilePath = XSL_TRANSFORM_INPUT_DIRPATH + "test1.xml"; 
    ...
    @Test
    public void xslCharacterMapTest8() {
    ...
    @Test
    public void xslCharacterMapTest9() {
    ...
    @Test
    public void xslCharacterMapTest10() {
    ...
    @Test
    public void xslCharacterMapTest11() {
    ...
    @Test
    public void xslCharacterMapTest12() {
