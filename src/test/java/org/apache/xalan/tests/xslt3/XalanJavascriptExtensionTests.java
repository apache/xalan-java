 ...
 * @xsl.usage advanced
 */
public class XalanJavascriptExtensionTests extends XslTransformTestsUtil {        
    
    private static final String XSL_TRANSFORM_INPUT_DIRPATH = XSLTestConstants.XSL_TRANSFORM_INPUT_DIRPATH_PREFIX + "javascript_extension/";
    
    private static final String XSL_TRANSFORM_GOLD_DIRPATH = XSLTestConstants.XSL_TRANSFORM_GOLD_DIRPATH_PREFIX + "javascript_extension/gold/";
    ...
    @Test
    public void xalanJavascriptExtensionTest11() {
    ...
    @Test
    public void xalanJavascriptExtensionTest12() {
    ...
    @Test
    public void xalanJavascriptExtensionTest13() {
    ...
    @Test
    public void xalanJavascriptExtensionTest14() {
