...
public class XslForEachGroupTests extends XslTransformTestsUtil {
    ...
    @Test
    public void xslForEachGroupTest42() {
        String xmlFilePath = XSL_TRANSFORM_INPUT_DIRPATH + "test37.xml"; 
    ...
    @Test
    public void xslForEachGroupTest43_3() {
        String xmlFilePath = XSL_TRANSFORM_INPUT_DIRPATH + "test37_3.xsl"; 
        String xslFilePath = XSL_TRANSFORM_INPUT_DIRPATH + "test37_3.xsl";
