 ...
 * tests for xsl:sequence instruction and other instructions that
 * construct sequences.
 * 
 ...
 * @xsl.usage advanced
 */
public class XslSequenceTests extends W3CXslTransformTestsUtil {     
    ...
    @Test
    public void runXslSequenceTests() {    	
       runXslTestSet();
    }
