 ...
 * for XPath 3.1 qname equality.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XPath3QnameEqualTests extends W3CXPath3TestsUtil { 

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {    	    	
    	m_xslTransformTestSetFilePath = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "op/QName-equal.xml";
    	
        m_resultSubFolderName = "op";
    	
    	m_testResultFileName = "QName-equal_result.xml";
    }
    ...
    @Test
    public void runXslQnameEqualTests() {
