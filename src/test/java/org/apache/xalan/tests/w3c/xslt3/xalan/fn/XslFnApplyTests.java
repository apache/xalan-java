 ...
 * tests for XPath function fn:apply.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XslFnApplyTests extends W3CXslTransformTestsUtil {     

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {
    	m_xslTransformTestSetFilePath = W3C_XSLT3_TESTS_META_DATA_DIR_HOME + "xalan/fn/apply/_apply-test-set.xml";
    	m_resultSubFolderName = "xalan/fn";
    	
    	m_testResultFileName = "_apply-test-set_result.xml";    	   
    }
    ...
    @Test
    public void runXslFnApplyTests() {    	
       runXslTestSet();
    }
