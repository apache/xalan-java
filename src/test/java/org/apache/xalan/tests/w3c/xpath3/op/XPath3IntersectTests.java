 ...
 * for XPath 3.1 operator 'intersect'.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XPath3IntersectTests extends W3CXPath3TestsUtil { 

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {    	    	
    	m_xslTransformTestSetFilePath = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "op/intersect.xml";
    	
        m_resultSubFolderName = "op";
    	
    	m_testResultFileName = "intersect_result.xml";
    }
    ...
    @Test
    public void runXslIntersectTests() {
