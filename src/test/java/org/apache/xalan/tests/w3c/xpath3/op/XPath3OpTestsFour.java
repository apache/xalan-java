 ...
 * for XPath 3.1 Gregorian types.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XPath3OpTestsFour extends W3CXPath3TestsUtil {
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        m_test_set_fileArr = new String[] { "gDay-equal.xml", "gMonth-equal.xml", "gMonthDay-equal.xml", "gYear-equal.xml", "gYearMonth-equal.xml" };
        
        m_resultSubFolderName = "op";
        
        m_test_set_result_fileArr = new String[] { "gDay-equal_result.xml", "gMonth-equal_result.xml", "gMonthDay-equal_result.xml", 
        		                                                                                       "gYear-equal_result.xml", "gYearMonth-equal_result.xml" };
    }
