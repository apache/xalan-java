 ...
 * for XPath 3.1 union operators '|' & 'union'.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XPath3UnionTests extends W3CXPath3TestsUtil { 

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {    	    	
    	m_xslTransformTestSetFilePath = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "op/union.xml";
    	
        m_resultSubFolderName = "op";
    	
    	m_testResultFileName = "union_result.xml";
    }
