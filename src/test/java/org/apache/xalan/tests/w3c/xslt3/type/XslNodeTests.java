 ...
 * tests for XSL node types.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XslNodeTests extends W3CXslTransformTestsUtil {     

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {
    	m_xslTransformTestSetFilePath = W3C_XSLT3_TESTS_META_DATA_DIR_HOME + "type/node/_node-test-set.xml";
    	m_resultSubFolderName = "type";
    	m_testResultFileName = "_node-test-set_result.xml";    	   
    }
