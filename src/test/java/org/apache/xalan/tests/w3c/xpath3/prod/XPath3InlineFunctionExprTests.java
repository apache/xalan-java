 ...
 * for XPath 3.1 inline function expression.
 * 
 ...
 * 
 */
public class XPath3InlineFunctionExprTests extends W3CXPath3TestsUtil { 

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {    	    	
    	m_xslTransformTestSetFilePath = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "prod/InlineFunctionExpr.xml";
        m_resultSubFolderName = "prod";
    	
    	m_testResultFileName = "inline_function_expr_result.xml";
    }
