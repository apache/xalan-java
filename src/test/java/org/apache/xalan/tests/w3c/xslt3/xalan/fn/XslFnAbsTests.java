 ...
 * tests for XPath function fn:abs.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XslFnAbsTests extends W3CXslTransformTestsUtil {     

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {
    	m_xslTransformTestSetFilePath = W3C_XSLT3_TESTS_META_DATA_DIR_HOME + "xalan/fn/abs/_abs-test-set.xml";
    	m_resultSubFolderName = "xalan/fn";
    	
    	m_testResultFileName = "_abs-test-set_result.xml";    	   
    }
