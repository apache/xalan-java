 ...
 * tests for XSL templates.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XslTemplateTests extends W3CXslTransformTestsUtil {     

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {
    	m_xslTransformTestSetFilePath = W3C_XSLT3_TESTS_META_DATA_DIR_HOME + "decl/template/_template-test-set.xml";
    	m_resultSubFolderName = "decl";
    	
    	m_testResultFileName = "_template-test-set_result.xml";    	   
    }
    ...
    @Test
    public void runXslTemplateTests() {    	
       runXslTestSet();
    }
