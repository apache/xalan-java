 ...
 * tests for xsl:message instruction.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XslMessageTests extends W3CXslTransformTestsUtil {     

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {
    	m_xslTransformTestSetFilePath = W3C_XSLT3_TESTS_META_DATA_DIR_HOME + "insn/message/_message-test-set.xml";
    ...
    @Test
    public void runXslMessageTests() {    	
       runXslTestSet();
    }
