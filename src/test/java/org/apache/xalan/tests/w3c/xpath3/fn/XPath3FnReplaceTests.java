 ...
 * for XPath 3.1 function fn:replace.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XPath3FnReplaceTests extends W3CXPath3TestsUtil { 

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {    	    	
    	m_xslTransformTestSetFilePath = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "fn/replace.xml";
    	
        m_resultSubFolderName = "fn";
    	
    	m_testResultFileName = "replace_result.xml";
    }
    ...
    @Test
    public void runXslFnReplaceTests() {
