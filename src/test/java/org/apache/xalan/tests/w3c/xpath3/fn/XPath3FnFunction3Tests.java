...
public class XPath3FnFunction3Tests extends W3CXPath3TestsUtil {
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        m_test_set_fileArr = new String[] { "false.xml", "floor.xml", "format-integer.xml", "head.xml", "hours-from-dateTime.xml", 
        ...
        m_test_set_result_fileArr = new String[] { "false_result.xml", "floor_result.xml", "format-integer_result.xml", "head_result.xml", 
        		                                   "hours-from-dateTime_result.xml", "hours-from-duration_result.xml", "hours-from-time_result.xml", 
        		                                   "implicit-timezone_result.xml", "index-of_result.xml", "in-scope-prefixes_result.xml" };
    }
