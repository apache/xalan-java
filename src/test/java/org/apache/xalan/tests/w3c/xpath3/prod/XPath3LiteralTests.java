 ...
 * for XPath 3.1 literals.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XPath3LiteralTests extends W3CXPath3TestsUtil { 

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {    	    	
    	m_xslTransformTestSetFilePath = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "prod/Literal.xml";
        m_resultSubFolderName = "prod";
    	
    	m_testResultFileName = "literal_result.xml";
    }
    ...
    @Test
    public void runXslLiteralTests() {
