...
public class XslFnJsonToXmlTests extends W3CXslTransformTestsUtil {     
    ...
    public static void setUpBeforeClass() throws Exception {
    	m_xslTransformTestSetFilePath = W3C_XSLT3_TESTS_META_DATA_DIR_HOME + "xalan/fn/json-to-xml/_json_to_xml-test-set.xml";
    	m_resultSubFolderName = "xalan/fn";
    	
    	m_testResultFileName = "_json_to_xml-test-set_result.xml";    	   
    }
