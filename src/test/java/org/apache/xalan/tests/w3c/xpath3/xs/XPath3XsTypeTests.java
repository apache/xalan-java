 ...
 */
package org.apache.xalan.tests.w3c.xpath3.xs;
 ...
 * for XML Schema data types.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XPath3XsTypeTests extends W3CXPath3TestsUtil {
	
	private static final String m_xsl_test_set_base_dir = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "xs/";
	
	private static String[] m_test_set_fileArr = null;
	
	private static String[] m_test_set_result_fileArr = null;

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {    	    	                
        m_test_set_fileArr = new String[] { "anyURI.xml", "normalizedString.xml", "token.xml" };
        
        m_resultSubFolderName = "xs";
        
        m_test_set_result_fileArr = new String[] { "anyURI_result.xml", "normalizedString_result.xml", "token_result.xml" };
    }
    ...
    public void runXslTypeTests() {
    	...
    	for (int a1 = 0; a1 < length2; a1++) {    	
        	...
        	try {
        		document = m_xmlDocumentBuilder.parse(m_xsl_test_set_base_dir + m_test_set_fileArr[a1]);
    		...
    		try {
    			...
    			File xslAnalyzeStringTestResultFile = new File(new URI(W3C_XPATH3_TESTS_RESULT_DIR_HOME + m_resultSubFolderName + "/" 
    			                                                                                        + m_test_set_result_fileArr[a1]));
