 ...
 * for XPath 3.1 function array:append.
 * 
...
public class XPath3FunctionArrayAppendTests extends W3CXPath3TestsUtil { 
    ...
    public static void setUpBeforeClass() throws Exception {    	    	
    	m_xslTransformTestSetFilePath = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "array/append.xml";
    	
        m_resultSubFolderName = "array";
    	
    	m_testResultFileName = "append_result.xml";
    }
    ...
    @Test
    public void runXslFunctionArrayAppendTests() {
