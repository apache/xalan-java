 ...
 * for XPath 3.1 operator 'except'.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XPath3ExceptTests extends W3CXPath3TestsUtil { 

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {    	    	
    	m_xslTransformTestSetFilePath = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "op/except.xml";
    	
        m_resultSubFolderName = "op";
    	
    	m_testResultFileName = "except_result.xml";
    }
