 ...
 * tests for XPath function fn:analyze-string.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XslFnAnalyzeStringTests extends W3CXslTransformTestsUtil {     

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {
    	m_xslTransformTestSetFilePath = W3C_XSLT3_TESTS_META_DATA_DIR_HOME + "xalan/fn/analyze-string/_analyze-string-test-set.xml";
    ...
    @Test
    public void runXslFnAnalyzeStringTests() {    	
       runXslTestSet();
    }
