 ...
 * for XPath 3.1 'for' clause.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XPath3ForClauseTests extends W3CXPath3TestsUtil { 

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {    	    	    	
    	m_xslTransformTestSetFilePath = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "prod/ForClause.xml";
        m_resultSubFolderName = "prod";
    	
    	m_testResultFileName = "for_clause_result.xml";
    }
    ...
    @Test
    public void runXslForClauseTests() {
