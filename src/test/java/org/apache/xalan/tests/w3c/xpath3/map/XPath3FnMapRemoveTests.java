 ...
 * for XPath 3.1 function map:remove.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XPath3FnMapRemoveTests extends W3CXPath3TestsUtil { 

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {    	    	
    	m_xslTransformTestSetFilePath = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "map/remove.xml";
    	
        m_resultSubFolderName = "map";
    	
    	m_testResultFileName = "remove_result.xml";
    }
    ...
    @Test
    public void runXslFnMapRemoveTests() {
