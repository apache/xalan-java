 ...
 * for XPath 3.1 function fn:matches.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XPath3FnMatchesTests extends W3CXPath3TestsUtil { 

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {    	    	
    	m_xslTransformTestSetFilePath = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "fn/matches.xml";
    	
        m_resultSubFolderName = "fn";
    	
    	m_testResultFileName = "matches_result.xml";
    }
    ...
    @Test
    public void runXslFnMatchesTests() {
