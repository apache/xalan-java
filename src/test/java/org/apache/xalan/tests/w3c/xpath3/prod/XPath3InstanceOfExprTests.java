 ...
 * 
 */
public class XPath3InstanceOfExprTests extends W3CXPath3TestsUtil { 

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {    	    	
    	m_xslTransformTestSetFilePath = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "prod/InstanceofExpr.xml";
        m_resultSubFolderName = "prod";
    	
    	m_testResultFileName = "instance_of_expr_result.xml";
    }
    ...
    @Test
    public void runXslInstanceOfExprTests() {
