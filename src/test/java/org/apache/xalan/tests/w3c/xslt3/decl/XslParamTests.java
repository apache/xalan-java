 ...
 * tests for xsl:param instruction.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XslParamTests extends W3CXslTransformTestsUtil {     

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {
    	m_xslTransformTestSetFilePath = W3C_XSLT3_TESTS_META_DATA_DIR_HOME + "decl/param/_param-test-set.xml";
    	m_resultSubFolderName = "decl";
    	
    	m_testResultFileName = "_param-test-set_result.xml";
    	
    	// Xalan-J has bugs with following, W3C XSLT 3.0 test cases.
    	// Skipping these XSL test cases for now.
    	
    	m_skipped_tests_list.add("param-0301");
    }
