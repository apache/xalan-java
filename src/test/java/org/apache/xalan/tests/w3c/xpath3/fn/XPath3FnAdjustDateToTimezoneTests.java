 ...
 * for XPath 3.1 function fn:adjust-date-to-timezone.
 * 
...
public class XPath3FnAdjustDateToTimezoneTests extends W3CXPath3TestsUtil { 
    ...
    public static void setUpBeforeClass() throws Exception {    	    	
    	m_xslTransformTestSetFilePath = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "fn/adjust-date-to-timezone.xml";
        m_resultSubFolderName = "fn";
    	
    	m_testResultFileName = "adjust-date-to-timezone_result.xml";
    }
