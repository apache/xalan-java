 ...
 * for XPath 3.1 function fn:lower-case.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XPath3FnLowerCaseTests extends W3CXPath3TestsUtil { 

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {    	    	
    	m_xslTransformTestSetFilePath = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "fn/lower-case.xml";
    	
        m_resultSubFolderName = "fn";
    	
    	m_testResultFileName = "lower-case_result.xml";
    }
    ...
    @Test
    public void runXslFnLowerCaseTests() {
