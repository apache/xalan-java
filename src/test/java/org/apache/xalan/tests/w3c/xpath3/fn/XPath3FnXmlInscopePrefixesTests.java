 ...
 * for XPath 3.1 function fn:in-scope-prefixes.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XPath3FnXmlInscopePrefixesTests extends W3CXPath3TestsUtil { 

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {    	    	
    	m_xslTransformTestSetFilePath = W3C_XPATH3_TESTS_META_DATA_DIR_HOME + "fn/in-scope-prefixes.xml";
    	
        m_resultSubFolderName = "fn";
    	
    	m_testResultFileName = "in-scope-prefixes_result.xml";
    }
    ...
    @Test
    public void runXslFnXmlInscopePrefixesTests() {
