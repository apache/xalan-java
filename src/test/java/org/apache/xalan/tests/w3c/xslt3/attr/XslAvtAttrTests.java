 ...
 * tests for XSLT AVT that is used to specify XSL attribute value
 * templates.
 * 
 ...
 * @xsl.usage advanced
 */
public class XslAvtAttrTests extends W3CXslTransformTestsUtil {     
    ...
    @Test
    public void runXslAvtAttrTests() {    	
       runXslTestSet();
    }
