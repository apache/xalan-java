...
public class XslExpressionTests extends W3CXslTransformTestsUtil {     
    ...
    public static void setUpBeforeClass() throws Exception {
    	m_xslTransformTestSetFilePath = "file:/d:/xslt30-test-master/tests/expr/expression/_expression-test-set.xml";
    	m_testResultFileName = "_expression-test-set_results.xml";    	   
    }
