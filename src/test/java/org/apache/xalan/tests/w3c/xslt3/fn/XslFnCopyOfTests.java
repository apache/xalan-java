 ...
 * tests for XPath function fn:copy-of.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XslFnCopyOfTests extends W3CXslTransformTestsUtil {     

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {
    	m_xslTransformTestSetFilePath = W3C_XSLT3_TESTS_META_DATA_DIR_HOME + "fn/copy-of/_copy-of-test-set.xml";
    	m_resultSubFolderName = "fn";
    	
    	m_testResultFileName = "_copy-of-test-set_result.xml";    	   
    }
    ...
    @Test
    public void runXslFnCopyOfTests() {    	
       runXslTestSet();
    }
