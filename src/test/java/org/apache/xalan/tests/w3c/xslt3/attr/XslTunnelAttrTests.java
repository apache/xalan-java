 ...
 * tests for XSLT 'tunnel' attribute.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XslTunnelAttrTests extends W3CXslTransformTestsUtil {     

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {
    	m_xslTransformTestSetFilePath = W3C_XSLT3_TESTS_META_DATA_DIR_HOME + "attr/tunnel/_tunnel-test-set.xml";
    	m_resultSubFolderName = "attr";    	
    	
    	m_testResultFileName = "_tunnel-test-set_result.xml";
    }
    ...
    @Test
    public void runXslTunnelAttrTests() {    	
       runXslTestSet();
    }
