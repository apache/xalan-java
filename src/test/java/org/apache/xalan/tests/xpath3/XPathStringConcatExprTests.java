...
public class XPathStringConcatExprTests extends XslTransformTestsUtil {        
    ...
    private static final String XSL_TRANSFORM_GOLD_DIRPATH = XSLTestConstants.XSL_TRANSFORM_GOLD_DIRPATH_PREFIX + "stringConcatExpr/gold/";
    ...
    @Test
    public void xslStringConcatExprTest6() {
