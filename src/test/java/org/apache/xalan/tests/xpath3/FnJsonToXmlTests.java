...
/**
 * XPath 3.1 function fn:json-to-xml test cases.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class FnJsonToXmlTests extends XslTransformTestsUtil {        
    
    private static final String XSL_TRANSFORM_INPUT_DIRPATH = XSLTestConstants.XSL_TRANSFORM_INPUT_DIRPATH_PREFIX + "fn_json_to_xml/";
    
    private static final String XSL_TRANSFORM_GOLD_DIRPATH = XSLTestConstants.XSL_TRANSFORM_GOLD_DIRPATH_PREFIX + "fn_json_to_xml/gold/";
    ...
    @Test
    public void xslFnJsonToXmlTest1() {
    ...
    @Test
    public void xslFnJsonToXmlTest2() {
    ...
    @Test
    public void xslFnJsonToXmlTest3() {
    ...
    @Test
    public void xslFnJsonToXmlTest4() {
    ...
    @Test
    public void xslFnJsonToXmlTest5() {
    ...
    @Test
    public void xslFnJsonToXmlTest6() {
    ...
    @Test
    public void xslFnJsonToXmlTest7() {
    ...
    @Test
    public void xslFnJsonToXmlTest8() {
    ...
    @Test
    public void xslFnJsonToXmlTest9() {
    ...
    @Test
    public void xslFnJsonToXmlTest10() {
