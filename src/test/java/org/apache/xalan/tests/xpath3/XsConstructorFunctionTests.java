...
public class XsConstructorFunctionTests extends XSLTransformTestsUtil {        
    ...
    private static final String XSL_TRANSFORM_INPUT_DIRPATH = XSLTestConstants.XSL_TRANSFORM_INPUT_DIRPATH_PREFIX + "xs_constructor_functions/";
    
    private static final String XSL_TRANSFORM_GOLD_DIRPATH = XSLTestConstants.XSL_TRANSFORM_GOLD_DIRPATH_PREFIX + "xs_constructor_functions/gold/";
    ...
    @Test
    public void XsConstructorFunctionsTest28() {
