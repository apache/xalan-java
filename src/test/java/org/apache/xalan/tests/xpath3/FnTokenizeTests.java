...
public class FnTokenizeTests extends XslTransformTestsUtil {
    ...
    private static final String XSL_TRANSFORM_GOLD_DIRPATH = XSLTestConstants.XSL_TRANSFORM_GOLD_DIRPATH_PREFIX + "fn_tokenize/gold/";
    ...
    public void xslFnTokenizeTest11() {
        ...
        String goldFilePath = getXslTransformGoldFilePath(XSL_TRANSFORM_GOLD_DIRPATH + "test11.out");
