...
public class XPathArrowOpTests extends XslTransformTestsUtil {        
    ...
    private static final String XSL_TRANSFORM_INPUT_DIRPATH = XSLTestConstants.XSL_TRANSFORM_INPUT_DIRPATH_PREFIX + "xpath_arrow_op/";
    
    private static final String XSL_TRANSFORM_GOLD_DIRPATH = XSLTestConstants.XSL_TRANSFORM_GOLD_DIRPATH_PREFIX + "xpath_arrow_op/gold/";
    ...
    @Test
    public void xslXPathArrowOpTest5() {
    ...
    @Test
    public void xslXPathArrowOpTest6() {
    ...
    @Test
    public void xslXPathArrowOpTest7() {
    ...
    @Test
    public void xslXPathArrowOpTest8() {
    ...
    @Test
    public void xslXPathArrowOpTest9() {
    ...
    @Test
    public void xslXPathArrowOpTest10() {
