...
/**
 * XSL stylesheet test cases to test, XPath literal sequence constructor 
 * expressions having an index accessor.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XPathOpLiteralSequenceTests extends XslTransformTestsUtil {        
    
    private static final String XSL_TRANSFORM_INPUT_DIRPATH = XSLTestConstants.XSL_TRANSFORM_INPUT_DIRPATH_PREFIX + 
                                                                                                   "xpath_op_literal_sequence/";
    
    private static final String XSL_TRANSFORM_GOLD_DIRPATH = XSLTestConstants.XSL_TRANSFORM_GOLD_DIRPATH_PREFIX + 
                                                                                                   "xpath_op_literal_sequence/gold/";
    ...
    @Test
    public void xpathOpLiteralSequenceTest1() {
    ...
    @Test
    public void xpathOpLiteralSequenceTest2() {
    ...
    @Test
    public void xpathOpLiteralSequenceTest3() {
    ...
    @Test
    public void xpathOpLiteralSequenceTest4() {
    ...
    @Test
    public void xpathOpLiteralSequenceTest5() {
