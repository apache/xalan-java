 ...
 * @xsl.usage advanced
 */
public class GroupingWithSortTests {
    
    private static final String xslTransformInputDirPath = XSLConstants.XSL_TRANSFORM_INPUT_DIR_PATH_PREFIX + "grouping/sort/";
    
    private static final String xslTransformGoldDirPath = XSLConstants.XSL_TRANSFORM_GOLD_DIR_PATH_PREFIX + "grouping/sort/gold/";      
    ...
    @Test
    public void test1() {
        String xmlFilePath = xslTransformInputDirPath + "test_1a.xml"; 
    ...
    @Test
    public void test2() {
        String xmlFilePath = xslTransformInputDirPath + "test_1b.xml"; 
    ...
    @Test
    public void test4() {
        String xmlFilePath = xslTransformInputDirPath + "test_1c.xml"; 
