 ...
 * @xsl.usage advanced
 */
public class FnTokenizeTests {
    
    private static final String xslTransformInputDirPath = XSLConstants.XSL_TRANSFORM_INPUT_DIR_PATH_PREFIX + "fn_tokenize/";
    
    private static final String xslTransformGoldDirPath = XSLConstants.XSL_TRANSFORM_GOLD_DIR_PATH_PREFIX + "fn_tokenize/gold/";
    ...
    @Test
    public void test10() {
        String xmlFilePath = xslTransformInputDirPath + "test10.xsl"; 
